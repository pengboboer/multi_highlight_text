...
/// other user interface action. Wrap the button in a [ClickTooltip] widget and provide
/// a message which will be shown when the widget is long pressed.
///
/// Many widgets, such as [IconButton], [FloatingActionButton], and
/// [PopupMenuButton] have a `tooltip` property that, when non-null, causes the
/// widget to include a [ClickTooltip] in its build.
///
...
///
/// {@tool dartpad}
/// This example show a basic [ClickTooltip] which has a [Text] as child.
...
/// `preferBelow` is false, the tooltip will prefer showing above [ClickTooltip]'s child widget.
...
///
/// {@tool dartpad}
/// This example shows a rich [ClickTooltip] that specifies the [richMessage]
...
///
/// {@tool dartpad}
/// This example shows how [ClickTooltip] can be shown manually with [TooltipTriggerMode.manual]
/// by calling the [ClickTooltipState.ensureTooltipVisible] function.
///
...
class ClickTooltip extends StatefulWidget {
  ...
  /// [ClickTooltip.message] if non-null, or the plain text value of
  /// [ClickTooltip.richMessage] otherwise. Set this property to true if the app is
  ...
  static final List<ClickTooltipState> _openedTooltips = <ClickTooltipState>[];
  ...
  static void _concealOtherTooltips(ClickTooltipState current) {
    if (_openedTooltips.isNotEmpty) {
      // Avoid concurrent modification.
      final List<ClickTooltipState> openedTooltips = _openedTooltips.toList();
      for (final ClickTooltipState state in openedTooltips) {
        if (state == current) {
          continue;
        }
  ...
  @override
  State<ClickTooltip> createState() => ClickTooltipState();
...
/// Contains the state for a [ClickTooltip].
///
...
class ClickTooltipState extends State<ClickTooltip>
  ...
  bool ensureTooltipVisible() {
    ...
    if (_isConcealed) {
      if (_mouseIsConnected) {
        ClickTooltip._concealOtherTooltips(this);
      }
      _revealTooltip();
      return true;
    }
  ...
  static final Set<ClickTooltipState> _mouseIn = <ClickTooltipState>{};
  ...
  void _createNewEntry() {
    ...
    assert(!ClickTooltip._openedTooltips.contains(this));
    ClickTooltip._openedTooltips.add(this);
  }

  void _removeEntry() {
    ClickTooltip._openedTooltips.remove(this);
    ...
    _entry = null;
    if (_mouseIsConnected) {
      ClickTooltip._revealLastTooltip();
    }
  }
